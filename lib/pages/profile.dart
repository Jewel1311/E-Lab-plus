...
class _ProfileState extends State<Profile> {
  ...
  Future getProfile() async {
    ...
    lab = await supabase.from('labs').select().match({'user_id':supabase.auth.currentUser!.id});
    nameController.text = lab[0]['labname'];
    phoneController.text = lab[0]['phone'].toString();
    cityController.text = lab[0]['city'];
